...
<div class="container pb-5">
    <div class="row">
        <div class="col-12 text-center">
            <h1 class="text-primary mb-3 fw-bold">Contact Us</h1>
        </div>
    </div>
    <div class="row mt-5">
        <div class="col-md-6 pb-5 pb-md-0">
            <div class="card rounded p-5 text-center bg-secondary-lighter">
                <h2 class="mb-4 animate-on-scroll slide-left text-white fw-bold">Contact Info
                </h2>
        ...
        <div class="col-md-6">
            <div class="card rounded p-5 text-center bg-tertiary">
                <h2 class="mb-4 animate-on-scroll slide-right text-white fw-bold">
                    Send Us A Message
                </h2>
