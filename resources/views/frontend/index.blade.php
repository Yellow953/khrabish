    ...
    <div class="container py-5">
        ...
        <div class="col-md-12 mt-5 text-center">
            ...
            <div class="row mt-5 mb-4">
                ...
                <div class="col-12 col-md-4 pb-4 pb-md-0">
                    <div
                        class="card rounded-5 py-5 text-center bg-secondary-light animate-on-scroll slide-up border-0 box-shadow-secondary">
                ...
                <div class="col-12 col-md-4">
                    <div
                        class="card rounded-5 py-5 text-center bg-tertiary-light animate-on-scroll slide-right border-0 box-shadow-tertiary">
