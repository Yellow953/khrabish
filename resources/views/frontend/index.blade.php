...
<div class="container py-3 py-md-5">
    <div class="row">
        <div class="col-12 col-md-4 pb-4 pb-md-0">
            <div class="card rounded-5 py-3 text-start align-items-start ps-3 animate-on-scroll slide-left">
                <img src="{{ asset('frontend/images/categories/banners/home-items.png') }}" alt="Home Items"
                    class="banner-card-img">
                <h5 class="text-primary text-shadow-sm z-index-1 pt-2 pt-md-5">Home Items</h5>
        ...
        <div class="col-12 col-md-4 pb-4 pb-md-0">
            <div class="card rounded-5 py-3 text-start align-items-start ps-3 animate-on-scroll slide-up">
                <img src="{{ asset('frontend/images/categories/banners/kids.png') }}" alt="Kids Toys"
                    class="banner-card-img">
                <h5 class="text-secondary-light text-shadow-secondary-sm z-index-1 pt-2 pt-md-5">Kids Toys</h5>
                <div class=" d-flex flex-column y-on-hover-sm">
        ...
        <div class="col-12 col-md-4">
            <div class="card rounded-5 py-3 text-start align-items-start ps-3 animate-on-scroll slide-right">
                <img src="{{ asset('frontend/images/categories/banners/bathroom.png') }}" alt="Bathroom"
                    class="banner-card-img">
                <h5 class="text-primary text-shadow-sm z-index-1 pt-2 pt-md-5">Bathroom</h5>
                <div class=" d-flex flex-column y-on-hover-sm">
    ...
    <div class="row">
        <div class="col-12 col-md-6 pb-4 pb-md-0">
            <div class="card rounded-5 py-3 text-start align-items-start ps-3 animate-on-scroll slide-left">
                <img src="{{ asset('frontend/images/categories/banners/cleaning.png') }}" alt="Cleaning Supplies"
                    class="banner-card-img">
                <h5 class="text-secondary-light text-shadow-tertiary-sm z-index-1 pt-2 pt-md-5">Cleaning Supplies</h5>
                <div class=" d-flex flex-column y-on-hover-sm">
        ...
        <div class="col-12 col-md-6">
            <div class="card rounded-5 py-3 text-start align-items-start ps-3 animate-on-scroll slide-right">
                ...
                <h5 class="text-secondary-light text-shadow-secondary-sm z-index-1 pt-2 pt-md-5">Phone Accessories</h5>
                <div class=" d-flex flex-column y-on-hover-sm">
