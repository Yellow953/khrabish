...
<div class="container">
    <div class="col-md-12 mt-5">
        <h4 class="mt-5">Best Sellers</h4>
        <div class="owl-carousel owl-theme products">
            @foreach ($products as $product)
            <div class="product-item y-on-hover my-2">
                <a href="{{ route('shop') }}" class="text-decoration-none text-primary">
                    ...
                    <div class="d-flex flex-column product-title">
                        <h4 class="text-center mt-2 text-shadow-sm">{{ $product->name }}</h4>
                    </div>
                </a>
            </div>
            @endforeach
...
<div class="container py-5">
    <div class="row">
        ...
        <div class="col-md-12 my-4">
            <h4 class="mt-5">Latest Additions</h4>
            <div class="owl-carousel owl-theme products">
                @foreach ($products as $product)
                <div class="product-item y-on-hover my-2">
                    <a href="{{ route('shop') }}" class="text-decoration-none text-primary">
    ...
    <div class="col-md-12">
        <h4 class="mt-5">Products For You</h4>
        <div class="owl-carousel owl-theme products">
            @foreach ($products as $product)
            <div class="product-item y-on-hover my-2">
                <a href="{{ route('shop') }}" class="text-decoration-none text-primary">
